...
|---------|---------|
|<a href='http://boxstarter.org/package/url?https://raw.githubusercontent.com/PushOrigin/pushorigin-windows-dev-box-setup-scripts/master/dev_app_desktop_.NET.ps1'>PushOrigin .NET Desktop App</a>     | Windows Desktop App Development (Visual Studio, Windows SDK, .NET (WPF and Winforms)) |
